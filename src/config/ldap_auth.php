...
return [
    ...
    */
    ...
    'identifiers' => [
        ...
        */
        ...
        // Adldap2-Laravel ldap auth documentation
        // https://adldap2.github.io/Adldap2-Laravel/#/auth/setup?id=ldap

        'ldap' => [

            // 'locate_users_by' => 'employeeID', // locate user by the default employeeID value, which is the A0#
    ...
    */
    ...
    'sync_attributes' => [
        ...
        // 'username' => 'mail', // Do not use 'employeeID' here
        'username' => 'userPrincipalName',  // note that the username MUST be unique value
